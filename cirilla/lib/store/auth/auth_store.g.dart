...
mixin _$AuthStore on _AuthStore, Store {
  ...
  User? get user => (_$userComputed ??=
          Computed<User?>(() => super.user, name: '_AuthStore.user'))
      .value;
  ...
  bool? get loadingEditAccount => (_$loadingEditAccountComputed ??=
          Computed<bool?>(() => super.loadingEditAccount,
              name: '_AuthStore.loadingEditAccount'))
      .value;
  ...
  final _$_loadingEditAccountAtom =
      Atom(name: '_AuthStore._loadingEditAccount');
