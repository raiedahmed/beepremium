...
import 'package:cirilla/store/transaction_wallet/transaction_wallet_store.dart';
...
abstract class _AuthStore with Store {
  ...
  late TransactionWalletStore transactionWalletStoreStore;
  ...
  Future<bool> logout() async {
    ...
    try {
      ...
      print('Logout error or not logged!');
    }
  ...
  _AuthStore(this._persistHelper, this._requestHelper) {
    ...
    this.productRecentlyStore = ProductRecentlyStore(_persistHelper);
    this.postWishListStore = PostWishListStore(_persistHelper);
    this.locationStore = LocationStore(_persistHelper);
    this.transactionWalletStoreStore = TransactionWalletStore(_requestHelper, auth: this as AuthStore);
    init();
  }
