...
import 'package:cirilla/widgets/cirilla_ads_bottom.dart';
...
class _PostScreenState extends State<PostScreen> with PostMixin, AppBarMixin, SnackMixin, LoadingMixin {
  ...
  Widget buildLayout(Post? post) {
    return Observer(builder: (_) {
      ...
      return CirillaAdsBottom(child: PostHtml(post: post, layout: layout, styles: widgetConfig!.styles, configs: configs, rows: rows));
    });
  }
}
