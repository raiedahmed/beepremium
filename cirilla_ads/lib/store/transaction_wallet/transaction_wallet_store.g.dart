...
part of 'transaction_wallet_store.dart';
...
mixin _$TransactionWalletStore on _TransactionWalletStore, Store {
  Computed<bool>? _$loadingComputed;

  @override
  bool get loading => (_$loadingComputed ??= Computed<bool>(() => super.loading,
          name: '_TransactionWalletStore.loading'))
      .value;
  ...
  ObservableList<TransactionWallet> get transactionWallets =>
      (_$transactionWalletsComputed ??=
              Computed<ObservableList<TransactionWallet>>(
                  ...
                  name: '_TransactionWalletStore.transactionWallets'))
          .value;
  ...
  double get amountBalance =>
      (_$amountBalanceComputed ??= Computed<double>(() => super.amountBalance,
              name: '_TransactionWalletStore.amountBalance'))
          .value;

  final _$fetchTransactionWalletsFutureAtom =
      Atom(name: '_TransactionWalletStore.fetchTransactionWalletsFuture');
  ...
  final _$_transactionWalletsAtom =
      Atom(name: '_TransactionWalletStore._transactionWallets');
  ...
  final _$successAtom = Atom(name: '_TransactionWalletStore.success');
  ...
  final _$_nextPageAtom = Atom(name: '_TransactionWalletStore._nextPage');
  ...
  final _$_perPageAtom = Atom(name: '_TransactionWalletStore._perPage');
  ...
  final _$_canLoadMoreAtom = Atom(name: '_TransactionWalletStore._canLoadMore');
  ...
  final _$_userIdAtom = Atom(name: '_TransactionWalletStore._userId');
  ...
  final _$_amountBalanceAtom =
      Atom(name: '_TransactionWalletStore._amountBalance');
  ...
  final _$getAmountBalanceAsyncAction =
      AsyncAction('_TransactionWalletStore.getAmountBalance');
  ...
  final _$getTransactionWalletsAsyncAction =
      AsyncAction('_TransactionWalletStore.getTransactionWallets');
  ...
  final _$_TransactionWalletStoreActionController =
      ActionController(name: '_TransactionWalletStore');

  @override
  Future<void> refresh() {
    final _$actionInfo = _$_TransactionWalletStoreActionController.startAction(
        name: '_TransactionWalletStore.refresh');
    try {
      return super.refresh();
    } finally {
      _$_TransactionWalletStoreActionController.endAction(_$actionInfo);
    }
  }
