        ...
        buildInfo(
          ...
          child: Column(
            children: [
              ...
              //     size: 16,
              //   ),
              //   trailing: Text(formatCurrency(context, price: '$amountBalance')),
...
class _WalletItemState extends State<_WalletItem> {
  ...
  void didChangeDependencies() {
    ...
    _authStore.transactionWalletStoreStore.getAmountBalance();
    ...
    return Observer(
      builder: (_) {
        return CirillaTile(
          ...
          trailing: Text(formatCurrency(context, price: '${_authStore.transactionWalletStoreStore.amountBalance}')),
          onTap: () => Navigator.of(context).pushNamed(Routes.wallet),
        );
      },
    );
