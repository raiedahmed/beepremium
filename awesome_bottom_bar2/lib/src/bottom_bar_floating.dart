...
// class BottomBarFloating extends BottomBar {
...
//           doubleBlur: blur,
//           styleCount: countStyle,
//           paddingVer: paddingVertical,
//         );
...
//                   return Flexible(
//                     child: InkWell(
//                       onTap: index != indexSelected ? () => onTap?.call(index) : null,
...
//   }) {
//     Color itemColor = isSelected ? colorSelected : color;

//     return Padding(
//       padding: EdgeInsets.symmetric(horizontal: 12, vertical: paddingVer ?? 17.0),
//       child: Column(
...
//             Text(
//               item.title!,
//               style: Theme.of(context).textTheme.overline?.merge(titleStyle).copyWith(color: itemColor),
